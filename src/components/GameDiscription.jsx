...
const GameDiscription = () => {
  ...
  return (
    <div className="gurdian_game-description-page">
      <div className="background-image"></div> {/* Large background image */}
      <div className="content">
        <h1 className="main-heading">Alabay Guardian</h1> {/* Main Heading */}
        <div className="sub-headings">
          <h3 className="sub-heading">Shepherd of the Steppes</h3> {/* First Subheading */}
